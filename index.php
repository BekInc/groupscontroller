<?php
ob_start();
define('API_KEY', '1137617735:AAHgQ57fYSB4Mq4QSKxhiTE19f8Qd6_Bdxk');
$admin = "1080227488"; 
$kanali = "@texnologiyapro";
...
$token = "617622346:AAEX6QbGyH-oyOX6sdoJKhILnl0MDBDd_GQ";
...
$baza = file_get_contents("Bekzod/xotira.txt");
$str = explode("\n", $baza);
foreach($str as $uz){
}
$ex = explode("|",$text1);
...
file_put_contents("Bekzod/xotira.txt","$baza\n$savol|$javob");
}
}
...
file_put_contents("Bekzod/xotira.txt",$str);
bot ('SendMessage', [
'chat_id'=> $chat_id, 
'text'=>"✅ Gap o'chirildi",
'reply_to_message_id'=> $mid,
...
💎Bosh homiy: @UzBotsGroup",
'parse_mode'=>"html",
'reply_to_message_id'=> $mid,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"💎UzBotsGroup",'url'=>"https://telegram.me/UzBotsGroup"]]
]
])
]);
}
...
file_put_contents("Bekzod/$chat_id.wel",$wel);
}
...
file_put_contents("Bekzod/$fadmin2.step","");
}
}
...
file_put_contents("Bekzod/$chat_id2.step","setchannel");
}else{
...
$step1 = file_get_contents("Bekzod/$chat_id.step");
if($step1 == "setchannel"){
$gett = bot('GetChatMember', [
'chat_id'=> $chat_id,
'user_id'=> $fadmin,
...
file_put_contents("Bekzod/$chat_id.channel",$text1);
unlink("Bekzod/$chat_id.step");
}else{
bot ('SendMessage', [
'chat_id'=> $chat_id,
'parse_mode'=>"markdown",
...
if ($cty == "group" or $cty == "supergroup"){
$channel = file_get_contents("Bekzod/$chat_id.channel");
if ($channel == null){
$channel = "@texnologiyapro";
}
$us = bot('getchat', [
'chat_id'=> $channel,
]);
...
$adminlist = file_get_contents("Bekzod/adminlar/$chat_id");
...
file_put_contents("Bekzod/adminlar/$chat_id", $fadmin);
...
if ($text1 == "/sozlama" or $text1 == "/sozlama@GroupsControllerroBot"){
if ($cty == "group" or $cty == "supergroup"){
$gett = bot('getChatMember', [
'chat_id'=> $chat_id,
'user_id'=> $fadmin,
...
if($text1 == "/silent" or $text1 == "silent" or $text1 == "/silent@GroupsControllerroBot"){
$gett = bot('getChatMember', [
'chat_id'=> $chat_id,
'user_id'=> $fadmin,
]);
...
[['text'=>"ℹ Kanalimiz",'url'=>"https://telegram.me/texnologiyapro"]]
    ]
    ])
]);
}
...
if($text1  == "/unsilent" or $text1 == "unsilent" or $text1  == "/unsilent@GroupsControllerroBot"){
$gett = bot('getChatMember', [
'chat_id'=> $chat_id,
'user_id'=> $fadmin,
]);
...
'parse_mode'=>"html",
   'reply_markup'=>json_encode([
      'inline_keyboard'=>[
[['text'=>"$repname", 'url'=>"https://telegram.me/$repuser"]],
[['text'=>"ℹKanalimiz",'url'=>"https://telegram.me/texnologiyapro"]]
    ]
    ])
]);
}
...
if($text1=="/adminlar" or $text1 == "/adminlar@GroupsControllerroBot"){
...
'caption'=>"@GroupsControllerroBot *code*",
'parse_mode'=>"markdown",
'reply_to_message_id'=>$mid,
]);
}
...
$yangilar = file_get_contents("Bekzod/yangilar.txt");



if(isset($update) and $Ssalom == "true"){
if ($new_chat_members) {
$wel = file_get_contents("Bekzod/$chat_id.wel");
...
if ($text1 == "/start" or $text1 == "/start@GroupsControllerroBot" or $text1 == "/sozlama" or $text1 == "/sozlama@GroupsControllerroBot"){
$gett = bot('getChatMember', [
'chat_id'=> $chat_id,
'user_id'=> $fadmin,
]);
...
if ($text1 == "/start" or $text1 == "/start@GroupsControllerroBot" and $cty =="private"){
$chm = file_get_contents("news.txt");
bot('forwardMessage', [
'chat_id'=>$chat_id,
'from_chat_id'=>$kanali,
...
$ex = explode("_", $data);
file_put_contents("Bekzod/$chat_id.jins","$ex[1]");
bot ('EditMessageText', [
'chat_id'=>$chat_id2,
'message_id'=>$message_id2,
'parse_mode'=>"html",
...
$ex = explode("_", $data);
file_put_contents("Bekzod/$chat_id.yosh","$ex[1]");
$jins = file_get_contents("Bekzod/$chat_id.jins");
$yosh = file_get_contents("Bekzod/$chat_id.yosh");
  if($lname2 == null){
  $lname2 = "🚫Mavjud emas";
  }
$user = "@$username2";
...
'message_id'=> $message_id2,
'text'=>"😉Salom, $name2!
😁Meni tanigan bo'lsangiz kerak Xullas men <b>guruhlarda ishlayman</b> meni guruhizga admin qiling men gruppani nazorat qilishni qiyivoraman!
...
[['text'=>"💎Qiziqarli",'callback_data'=>"dost"]],
[['text'=>"➡Guruhga qo'shish",'url'=>"telegram.me/GroupsControllerroBot?startgroup=new"]]
]
]),
]);
bot('SendMessage', [
...
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
[['text'=>"ℹBuyruqlarim",'callback_data'=>"buyruq"]],
[['text'=>"📊Statistikam",'callback_data'=>"stat"]],
[['text'=>"💎Qiziqarli",'callback_data'=>"dost"]],
[['text'=>"➡Guruhga qo'shish",'url'=>"telegram.me/GroupsControllerroBot?startgroup=new"]]
]
]),
...
*Qo'llab-quvvatlash markazi:* [@Gepro_bot]",
'parse_mode'=>"markdown",
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
...
bot ('SendMessage', [
'chat_id'=> $chat_id,
'text'=>"🇺🇿Uzbek: *$uzb*\n\n🔁Tarjimon: [@GroupsControllerroBot]",
'parse_mode'=>"markdown",
'reply_to_message_id'=> $mid,
]);
}
...
bot ('SendMessage', [
'chat_id'=> $chat_id,
'text'=>"🇺🇸English: *$english*\n\n🔁Translate: [@GroupsControllerroBot]",
'parse_mode'=>"markdown",
'reply_to_message_id'=> $mid,
]);
}
...
bot ('SendMessage', [
'chat_id'=> $chat_id,
'text'=>"🇷🇺Русский: *$rus*\n\n🔁Переводчик: [@GroupsControllerroBot]",
'parse_mode'=>"markdown",
'reply_to_message_id'=> $mid,
]);
}
...
➡ `http://telegram.me/share/url?$texnologiyapro`

💎*Yaratuvchi:* [GroupsControllerroBot](https://t.me/GroupsControllerroBot)",
   ]);
 }
...
bot ('SendPhoto', [
'chat_id'=> $chat_id,
'photo'=>"http://www.keepcalmstudio.com/-/p.php?t=%EE%BB%AA%0D%0A$texnologiyapro%0D%0A%0D%0A%EE%BB%AE%20%20And%20%20%EE%BB%AE%0D%0A%0D%0A%EE%BB%AAby: @GroupsControllerroBot&bc=000000&tc=FFFFFF&cc=FF0000&uc=true&ts=true&ff=PNG&w=500&ps=sq",
'caption'=>"💎*Yaratuvchi:* [GroupsControllerroBot](https://t.me/GroupsControllerroBot)",
'parse_mode'=>"markdown",
'reply_to_message_id'=> $mid,
]);
}
...
bot ('SendPhoto', [
'chat_id'=> $chat_id,
'photo'=>"http://api.s-shot.ru/?$texnologiyapro",
'caption'=>"*💎Yaratuvchi:* [GroupsControllerroBot](https://t.me/GroupsControllerroBot)",
'parse_mode'=>"markdown",
'reply_to_message_id'=> $mid,
]);
...
[['text'=>"💎Botga kirish",'url'=>"https://t.me/GroupsControllerroBot"],],
[['text'=>"👥Guruhga qo'shish",'url'=>"telegram.me/GroupsControllerroBot?startgroup=new"],],]],
]
])
]);
...
if($text1 == "/setphoto" or $text1 == "/setphoto@GroupsControllerroBot"){
$gett = bot('getChatMember', [
'chat_id'=>$chat_id,
'user_id'=>$fadmin,
]);
...
file_put_contents("Bekzod/photogp.png",file_get_contents("https://api.telegram.org/file/bot$token/$patch"));
bot('setChatPhoto',[
'chat_id'=>$chat_id,
'photo'=>new CURLFile("Bekzod/photogp.png")
]);
bot('sendmessage',[
'chat_id'=>$chat_id,
'parse_mode'=>"html",
...
unlink("Bekzod/photogp.png");
}
}

if($text1 == "/delphoto" or $text1 == "/delphoto@GroupsControllerroBot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($text1 == "/leave"  or $text1 == "/leave@GroupsControllerroBot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
'chat_id'=>$chat_id,
'parse_mode'=>"html",
'text'=>"📛@GroupsControllerroBot'<b>ning guruhdagi faoliyati to'xtatildi:</b>
...
if ($text1 == "/admins" or $text1 == "/admins@GroupsControllerroBot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($text1 =="/text@GroupsControllerroBot" or $text1 =="/text") {
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($text1=="/ban" or $text1=="/Ban" or $text1=="/ban@GroupsControllerroBot"){
  $gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($text1 =="/ro" or $text1 =="/ro@GroupsControllerroBot"){
  $gett=bot('getchatmember',[
'chat_id'=>$chat_id,
'user_id'=>$fadmin,
]);
...
if($text1=="/unro" or $text1 =="/unro@GroupsControllerroBot"){
$gett=bot("getchatmember",[
'chat_id'=>$chat_id,
'user_id'=>$fadmin,
]);
...
if($text1 =="/kick" or $text1 =="/kick@GroupsControllerroBot"){
$gett=bot("getchatmember",[
'chat_id'=>$chat_id,
'user_id'=>$fadmin,
]);
...
if($text1 =="/warn" or $text1 =="/warn@GroupsControllerroBot"){
$gett=bot("getchatmember",[
'chat_id'=>$chat_id,
'user_id'=>$fadmin,
]);
...
if($text1 =="/nowarn" or $text1 =="/nowarn@GroupsControllerroBot"){
$gett=bot("getchatmember",[
'chat_id'=>$chat_id,
'user_id'=>$fadmin,
]);
...
if($text1 =="/mywarn" or $text1 =="/mywarn@GroupsControllerroBot"){
$war=file_get_contents("warn1.dat");
$soni="$chat_id=$fadmin";
$str=substr_count($war,"$soni");
    bot('sendmessage',[
...
if($text1 =="/unban" or $text1 =="/unban@GroupsControllerroBot"){
$gett=bot("getchatmember",[
'chat_id'=>$chat_id,
'user_id'=>$fadmin,
]);
...
Namuna:*
`Gepro + https://t.me/texnologiyapro`",
          ]);      
}
...
$soni=substr_count($userlar,"\n")-1;
 ...
 $sended=$userr->ok;
if($sended){
$true=file_get_contents("Bekzod/send.ok");
file_put_contents("Bekzod/send.ok","$true\n$idlat");
}else{
$false=file_get_contents("Bekzod/send.no");
file_put_contents("Bekzod/send.no","$false\n$idlat");
}
}
$true=file_get_contents("Bekzod/send.ok");
$false=file_get_contents("Bekzod/send.no");
...
file_put_contents("Bekzod/send.ok","");
file_put_contents("Bekzod/send.no","");
  file_put_contents("stat/$chat_id.step","");
}
}
